...
\begin{itemize}
	\item $f:\R\to\R$
	\item $f:\R^n\to\R$ and $f:\R\to\R^n$
	\item $f:\R^n\to\R^m$
	\item $f:\R^{m\times n}\to\R$ and $f:\R\to\R^{m\times n}$
	\item $f:\R^{m\times n}\to\R^k$ and $f:\R^k\to\R^{m\times n}$
	\item $f:\R^{m\times n}\to\R^{k\times l}$
\end{itemize}
}

\lstinputlisting[firstline=1,lastline=120]{src/python/mlLib/differentialChecking.py}
