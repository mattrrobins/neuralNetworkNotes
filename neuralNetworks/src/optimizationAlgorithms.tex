...
\lstinputlisting[firstline=1,lastline=304]{src/python/gradientDescent/npGradientDescentWithMomentum.py}
...
\lstinputlisting[firstline=1,lastline=307]{src/python/gradientDescent/npRootMeanSquaredPropagation.py}
...
\lstinputlisting[firstline=1,lastline=316]{src/python/gradientDescent/npAdaptiveMomentEstimation.py}
...
\lstinputlisting[lastline=305]{src/py/gradDescent.py}
