...
\lstinputlisting[firstline=1,lastline=298]{src/python/gradientDescent/npMiniBatchGradientDescent.py}
...
\lstinputlisting[firstline=1,lastline=329]{src/python/gradientDescent/npGradientDescentWithMomentum.py}
...
\lstinputlisting[firstline=1,lastline=333]{src/python/gradientDescent/npRootMeanSquaredPropagation.py}
...
\lstinputlisting[firstline=1,lastline=321]{src/python/gradientDescent/npAdaptiveMomentEstimation.py}
...
\lstinputlisting[firstline=1, lastline=336]{src/python/gradientDescent/npLearningRateDecay.py}
