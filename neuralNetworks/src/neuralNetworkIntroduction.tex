...
There are mainly only a handful of activating functions we consider for our non-linearity conditions.  We have the sigmoid function $\sigma(z)$ given by
...
We have the rectified linear unit function $\relu(z)$ given by
$$\relu:\R\to[0,\infty),\qquad\relu(z)=\max\{0,z\}.$$
We finally have the leaky-ReLU function $\lrelu(z)$ given by
$$\lrelu:\R\to\R,\qquad \lrelu(z)=\max\{\beta z, z\},$$
